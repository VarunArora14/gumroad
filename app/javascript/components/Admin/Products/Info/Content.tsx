...
const AdminProductInfoContent = ({ info, isLoading }: { info: InfoProps; isLoading: boolean }) => {
  ...
  const hasDiscordIntegration = info.active_integrations.some((integration) => integration.type === "DiscordIntegration");
  ...
  return (
    <>
      <dl>
        ...
        <dt>Published</dt>
        <dd><BooleanIcon value={info.alive} /></dd>

        <dt>Listed on Discover</dt>
        <dd><BooleanIcon value={info.recommendable} /></dd>

        <dt>Staff-picked</dt>
        <dd><BooleanIcon value={info.staff_picked} /></dd>

        <dt>Preorder</dt>
        <dd><BooleanIcon value={info.is_in_preorder_state} /></dd>
        ...
        <dd><BooleanIcon value={info.has_stampable_pdfs} /></dd>

        <dt>Streaming</dt>
        <dd><BooleanIcon value={info.streamable} /></dd>

        <dt>Physical</dt>
        <dd><BooleanIcon value={info.is_physical} /></dd>

        <dt>Licensed</dt>
        <dd><BooleanIcon value={info.is_licensed} /></dd>

        <dt>Is Adult (on product)</dt>
        <dd><BooleanIcon value={info.is_adult} /></dd>

        <dt>Is Adult (on user)</dt>
        <dd><BooleanIcon value={info.user_all_adult_products} /></dd>
        ...
        <dd><BooleanIcon value={hasCircleIntegration} /></dd>

        <dt>Discord Channel</dt>
        <dd><BooleanIcon value={hasDiscordIntegration} /></dd>
      </dl>
    </>
  );
};
