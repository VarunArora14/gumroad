...
describe "OauthApplicationsPages", type: :system, js: true do
  ...
  it "generates tokens that do not have the mobile_api scope" do
    ...
    expect(application.access_tokens.last.scopes.to_a).to eq %w[edit_products view_sales mark_sales_as_shipped refund_sales revenue_share ifttt view_profile view_payouts resend_receipt]
  end
